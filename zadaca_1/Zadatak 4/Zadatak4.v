...
(*Pomocne leme*)
Lemma DNeg (a : B) : Not (Not a) = a.
Proof.
  destruct a; reflexivity.
Qed.

Lemma DeMorgan (a b : B) : Not (And a b) = Or (Not a) (Not b).
Proof.
  destruct a, b; reflexivity.
Qed.

Lemma ALU_Or_Subproof (a b : list B) : (OrL a b) = NotL(AndL (NotL a) (NotL b)).
Proof.
  intros.  
  revert b. induction a, b; simpl.
  -- reflexivity.
  -- reflexivity.
  -- reflexivity.
